...
export default function Footer() {
  return (
    <footer className="w-full bg-white dark:bg-[#0E0B16] border-t border-pink-100 dark:border-[#2D2248] pt-14 pb-12 text-zinc-600 dark:text-zinc-400 transition-colors font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Col 2: Curriculum Tracks with Stylish Bullets */}
          <div className="space-y-3">
            <h4 className="text-xs font-mono font-bold uppercase tracking-wider text-zinc-900 dark:text-[#FDF2F8] flex items-center gap-1.5">
              ...
              {TRACKS.map((track) => (
                <li key={track}>
                  <Link
                    ...
                    className="hover:text-pink-600 dark:hover:text-pink-400 transition-colors inline-flex items-center gap-2 group"
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-pink-400 dark:bg-pink-500/60 group-hover:scale-125 group-hover:bg-pink-600 transition-all shrink-0" />
          ...
          {/* Col 3: Interactive Visual Tools with Stylish Bullets */}
          <div className="space-y-3">
            <h4 className="text-xs font-mono font-bold uppercase tracking-wider text-zinc-900 dark:text-[#FDF2F8] flex items-center gap-1.5">
            ...
            <ul className="space-y-2 text-xs font-sans">
              <li>
                <Link href="/playground" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors inline-flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 dark:bg-emerald-500/60 group-hover:scale-125 group-hover:bg-emerald-600 transition-all shrink-0" />
                  <span>Playground Python IDE</span>
                </Link>
              </li>
              <li>
                <Link href="/playground?tab=guide" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors inline-flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 dark:bg-emerald-500/60 group-hover:scale-125 group-hover:bg-emerald-600 transition-all shrink-0" />
                  <span>Chart Decision Guide (15 Charts)</span>
                </Link>
              </li>
              <li>
                <Link href="/playground?tab=3d" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors inline-flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 dark:bg-emerald-500/60 group-hover:scale-125 group-hover:bg-emerald-600 transition-all shrink-0" />
                  <span>3D Surface & Wireframe Studio</span>
                </Link>
              </li>
              <li>
                <Link href="/playground?tab=subplots" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors inline-flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 dark:bg-emerald-500/60 group-hover:scale-125 group-hover:bg-emerald-600 transition-all shrink-0" />
                  <span>Subplot Layout Builder</span>
                </Link>
              </li>
              <li>
                <Link href="/#anatomy" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors inline-flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 dark:bg-emerald-500/60 group-hover:scale-125 group-hover:bg-emerald-600 transition-all shrink-0" />
                  <span>Matplotlib Figure Anatomy</span>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col space-y-2.5 text-xs font-sans">
              ...
              >
                <div className="w-6 h-6 rounded-lg bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 flex items-center justify-center text-red-600 shrink-0">
              ...
              >
                <div className="w-6 h-6 rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 flex items-center justify-center text-blue-600 shrink-0">
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
              ...
              >
                <div className="w-6 h-6 rounded-lg bg-pink-50 dark:bg-pink-500/10 border border-pink-200 dark:border-pink-500/20 flex items-center justify-center text-pink-600 shrink-0">
